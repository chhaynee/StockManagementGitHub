...
public class SkincareController {
    ...
    public AnchorPane SkincarePage;
    @FXML
    ...
    public void handleBackButton(ActionEvent event) {
        new SwichScene(SkincarePage, "Categorypage/Categorypage.fxml");
    }

    public void handleAddButton(ActionEvent event) {
        new SwichScene(SkincarePage, "thidafxmlpart/add_page.fxml");

    }

    public void handleEditButton(ActionEvent event) {
        new SwichScene(SkincarePage, "thidafxmlpart/edit_page.fxml");
    }
}
